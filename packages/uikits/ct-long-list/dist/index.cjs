...
const LongList = props => {
  ...
  const [, watch] = react$1.useIsVisible();
  ...
  React.useEffect(() => {
    ...
    if (!dom.isOverflow(containerRef.current, "vertical")) {
      return;
    }
    watch(bottomLineRef.current, onEndReached);
  }, [onEndReached, watch]);
  return /*#__PURE__*/jsxRuntime.jsxs(Col, {
    fx: "center",
    ref: containerRef,
    children: [/*#__PURE__*/jsxRuntime.jsx(List, {
      ...
      className: "loading-icon",
      children: loadingIcon || /*#__PURE__*/jsxRuntime.jsx(icons.LoadingOutlined, {})
