...
const __Viewport = react.styled(Col, {}, "baseStyle-buaGVr");
const __Main = react.styled(Col, {
  "variants-w-dynamic": "variants-w-dynamic-fstFxH"
}, "baseStyle-gdLUOP", {
  as: "main"
});
const _Page = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(__Viewport, {
    className: "viewport",
    ...restProps,
    children: /*#__PURE__*/jsxRuntime.jsx(__Main, {
      w: wOfDd,
      children: children
    })
  });
};
react.styled(_Page, {}, "baseStyle-PJLV");
