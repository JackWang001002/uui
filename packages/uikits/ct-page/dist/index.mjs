...
const __Viewport = styled(Col, {}, "baseStyle-buaGVr");
const __Main = styled(Col, {
...
const _Page = props => {
  ...
  return /*#__PURE__*/jsx(__Viewport, {
    className: "viewport",
    ...restProps,
    children: /*#__PURE__*/jsx(__Main, {
      w: wOfDd,
      children: children
    })
  });
};
styled(_Page, {}, "baseStyle-PJLV");
